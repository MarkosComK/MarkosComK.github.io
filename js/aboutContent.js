...
<h1 class="hidden">Hello, my name is Markos and i am a front-end developer.</h1>
<div class="profile-wrap hidden">
    <img src="./imagens/me-art.JPG" alt="">
    <div>
...
export const aboutContent2 = `<div>
<h1 class="show-content">Hello, my name is Markos and i am a front-end developer.</h1>
<div class="profile-wrap show-content">
    <img src="./imagens/me-art.JPG" alt="">
    <div>
        <p><strong>Markos Vinicius</strong></p>
        <p>Web-developer from Brazil, based in Portugal</p>
